...
make_group(gp3,
    ...
    EX(mul), EX(imul1), EX(div), EX(idiv)) // ?idex or ex???
...
make_group(gp4,
  ...
  /* 0xff */
make_group(gp5,
    EX(inc), EX(dec), EX(call), EX(call), // ?call
    EX(jmp), EX(jmp), EX(push), EMPTY)  //?jmp rm?
...
// !refer to -> https://nju-projectn.github.io/i386-manual/appa.htm
// !at 0x68, imul, imul1? imul2?
opcode_entry opcode_table [512] = {
  ...
  /* 0x20 */	IDEXW(G2E, and, 1), IDEX(G2E, and), IDEX(E2G, and), IDEX(E2G, and),
  ...
  /* 0x38 */	IDEXW(G2E, cmp, 1), IDEX(G2E, cmp), IDEXW(E2G, cmp, 1), IDEX(G2E, cmp),
  ...
  /* 0x68 */	IDEX(push_SI, push), IDEX(I_E2G, imul1), IDEXW(push_SI, push, 1), IDEXW(I_E2G, imul1, 1),
  ...
  /* 0xc0 */	IDEXW(gp2_Ib2E, gp2, 1), IDEX(gp2_Ib2E, gp2), EMPTY, EX(ret), //?ret
  /* 0xc4 */	EMPTY, EMPTY, IDEXW(mov_I2E, mov, 1), IDEX(mov_I2E, mov),
  /* 0xc8 */	EMPTY, EX(leave), EMPTY, EX(ret),  //?ret far
  /* 0xcc */	IDEXW(I, int, 1), IDEXW(I, int, 1), EMPTY, EX(iret),  //?int 3
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEXW(mov_E2G, movzx, 1), IDEXW(mov_E2G, movzx, 2), //?movzx
  /* 0xb8 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xbc */	EMPTY, EMPTY, IDEXW(mov_E2G, movsx, 1), IDEXW(mov_E2G, movsx, 2), //?movsx
